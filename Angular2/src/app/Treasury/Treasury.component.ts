...
export class TreasuryComponent implements OnInit {
  ...
  TreasuryRecordsId = new FormControl('', Validators.required);
  ...
  constructor(public serviceTreasury: TreasuryService, fb: FormBuilder) {
    this.myForm = fb.group({
      TreasuryRecordsId: this.TreasuryRecordsId,
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'TreasuryRecordsId': this.TreasuryRecordsId.value,
    ...
    this.myForm.setValue({
      'TreasuryRecordsId': null,
      'SeedlingPrice': null,
      'landrecord': null,
      'ownerEntity': null
    });

    return this.serviceTreasury.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceTreasury.updateAsset(form.get('TreasuryRecordsId').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceTreasury.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceTreasury.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.TreasuryRecordsId) {
        formObject.TreasuryRecordsId = result.TreasuryRecordsId;
      } else {
        formObject.TreasuryRecordsId = null;
      }
